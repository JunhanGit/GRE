const CACHE='gre-full-v4-22-6';
const ASSETS=['./','./index.html','./study.html','./library.html','./settings.html','./manifest.json','./sw4226.js','./icon-192.png','./icon-512.png','./apple-touch-icon.png'];
